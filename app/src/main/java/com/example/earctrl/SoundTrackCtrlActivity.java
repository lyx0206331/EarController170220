...
import com.example.earctrl.Utils.PlayThread;

/**
 * Created by adrian on 16-12-5.
 */

public class SoundTrackCtrlActivity extends Activity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {

    private static final String TAG = "SoundTrackCtrlActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_track_ctrl);
