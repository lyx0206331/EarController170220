...
namespace agora {
    ...
    namespace rtc {
        ...
        enum VIDEO_PROFILE_TYPE {                                   // res       fps  kbps
...
*/
        ...
        public:
          ...
          * @param [in] info
            ...
            */
            virtual int
            joinChannel(const char *channelKey, const char *channelName, const char *info,
                        uid_t uid) = 0;
        ...
        public:
            ...
            */
            ...
            int setRemoteVideoStreamType(uid_t uid, REMOTE_VIDEO_STREAM_TYPE streamType) {
                return setObject("rtc.video.set_remote_video_stream", "{\"uid\":%u,\"stream\":%d}",
                                 uid, streamType);
            }
            ...
            */
            ...
            int setVideoQualityParameters(bool preferFrameRateOverImageQuality) {
                return m_parameter->setBool("rtc.video.prefer_frame_rate",
